...
- **ACL 2025** – *Best Resource Paper Award*  
  *BRIGHTER: BRIdging the Gap in Human-Annotated Textual Emotion Recognition Datasets for 28 Languages.*  
  [Read the paper](https://aclanthology.org/2025.acl-long.436/) 

- **SemEval 2025** – *Best Task Paper Award*  
  *Task 11: Bridging the Gap in Text-Based Emotion Detection.*  
  *(See BRIGHTER as part of the shared task)*  
  [Task details](https://github.com/emotion-analysis-project/SemEval2025-Task11) 

- **NAACL 2025** – *Outstanding Paper Award*  
  *IrokoBench: A New Benchmark for African Languages in the Age of Large Language Models.*  
  [Read the paper](https://aclanthology.org/2025.naacl-long.139/)

- **Deep Learning Indaba 2025** – *Best Paper Award*  
  *The State of Large Language Models for African Languages.*  
  [Read the paper](https://arxiv.org/pdf/2506.02280)

---

## 2024
- **NeurIPS 2024 (C3NLP Workshop)** – *Best Non-archival Paper Award*  
  *BLEnD: Everyday Knowledge in Diverse Cultures and Languages.*  
  [Read the paper](https://arxiv.org/pdf/2406.09948)

- **SemEval 2024** – *Honourable Mention (Best Task Paper)*  
  *Semantic Textual Relatedness Task.*  
  [Read the paper](https://arxiv.org/pdf/2403.18933)

---

## 2023
- **AfricaNLP 2023 (Kigali)** – *Best Non-archival Paper Award*  
  *AfriSenti: A Twitter Sentiment Analysis Benchmark for African Languages.*  
  [Read the paper](https://aclanthology.org/2023.emnlp-main.862.pdf)

- **IJCNLP–AACL 2023** – *Area Chair Award*  
  *MasakhaNER: Named Entity Recognition for African Languages.*  
  [Read the paper](https://aclanthology.org/2021.tacl-1.66.pdf)

---

## 2020
- **EMNLP 2020 (Findings)** – *Wikimedia Research Award*  
  *Participatory Research for Low-resourced Machine Translation.*  
  [Read the paper](https://aclanthology.org/2020.findings-emnlp.195.pdf)

---

## Research Grants & Awards
- **2026** – *Fellow (PI)*: [Royal Society Career Development Fellowship](https://royalsociety.org/grants/career-development-fellowship/) — supporting research on natural language processing for African and other low-resource languages. *(£690,000)*  
...
- **2018** – Nigerian TETFund PhD Scholarship Award *($25,000)*  
- **2018** – NITDA MSc Scholarship Award 
- **2018** – Kano State Government Postgraduate Scholarship *(MSc in Computer Science, Declined)*

---

## Travel Awards
- **2022** – Google Africa Travel Award *($3,000)*  
...
## Project Recognition
- **2025** – *IRCAI Global Top 100 AI Projects Award*  
  **AfriHate: A Multilingual Collection of Hate Speech and Abusive Language Datasets for African Languages** — recognized for advancing UN Sustainable Development Goals.
  [Read the paper](https://aclanthology.org/2025.naacl-long.92.pdf)
